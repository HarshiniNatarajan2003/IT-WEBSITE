$(function () {
  ...
  Morris.Area({
    ...
    pointSize: 3,
    fillOpacity: 0,
    pointStrokeColors: ["#23913c", "#23913c", "#212529"],
    behaveLikeLine: !0,
    gridLineColor: "#e0e0e0",
    lineWidth: 3,
    hideHover: "auto",
    lineColors: ["#23913c", "#23913c", "#212529"],
    resize: !0,
  }),
    Morris.Area({
      ...
      pointSize: 0,
      fillOpacity: 0.4,
      pointStrokeColors: ["#23913c", "#23913c"],
      behaveLikeLine: !0,
      gridLineColor: "#e0e0e0",
      lineWidth: 0,
      smooth: !1,
      hideHover: "auto",
      lineColors: ["#23913c", "#23913c"],
      resize: !0,
    });
  new Morris.Line({
  ...
  Morris.Donut({
    ...
    Morris.Bar({
      ...
      ykeys: ["a", "b", "c"],
      labels: ["A", "B", "C"],
      barColors: ["#23913c", "#212529", "#23913c"],
      hideHover: "auto",
      gridLineColor: "#eef0f2",
      resize: !0,
    }),
    Morris.Area({
      ...
      lineColors: ["#272367", "#23913c", "#343a40"],
      xkey: "period",
      ykeys: ["iphone", "ipad", "itouch"],
